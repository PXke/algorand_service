...
SSR_CHROME_STYLE = (
    ...
    "border-top:4px solid #4A5BD0;background:#F7F4EE;"
    "font:17px/1.55 Georgia,'Times New Roman',serif;color:#171410}"
    "#ssr-body img{max-width:100%;height:auto}"
    "#ssr-body a{color:#3A49AD;text-decoration:none}"
    "#ssr-body a:hover{text-decoration:underline}"
    ".ssr-header{border-bottom:1px solid #E0D9CB;padding-bottom:16px;margin-bottom:20px;"
    "padding-top:20px}"
    ".ssr-masthead{margin-bottom:12px}"
    ".ssr-brand{margin:0;font:700 1.35em Georgia,'Times New Roman',serif}"
    ".ssr-brand a{color:inherit}"
    ".ssr-tagline{margin:4px 0 0;font:13px/1.4 system-ui,sans-serif;color:#6A6355}"
    ".ssr-nav ul{display:flex;flex-wrap:wrap;gap:6px 18px;margin:0;padding:0;list-style:none;"
    "font:14px system-ui,sans-serif}"
    ".ssr-nav a[aria-current=page]{font-weight:700;color:#171410;text-decoration:underline}"
    ".ssr-crumbs{margin:0 0 18px;font:13px system-ui,sans-serif;color:#6A6355}"
    ".ssr-crumbs ol{display:flex;flex-wrap:wrap;gap:4px 0;margin:0;padding:0;list-style:none}"
    ".ssr-crumbs li+li::before{content:'›';margin:0 8px;color:#8A9692}"
    ".ssr-main{margin-bottom:28px}"
    ".ssr-footer{border-top:1px solid #E0D9CB;padding-top:24px;"
    ...
    "text-transform:uppercase;color:#6A6355;font-weight:700}"
    ".ssr-footer ul{margin:0;padding:0;list-style:none}"
    ".ssr-footer li{margin:0 0 6px}"
    ".ssr-footer-brand h2{font-size:1.05em;letter-spacing:0;text-transform:none;color:#171410}"
    ".ssr-muted{color:#6A6355;font-size:.92em}"
    ".ssr-rights{margin:0;font-size:12px;color:#6A6355}"
    ".ssr-tags{font:14px system-ui,sans-serif;color:#6A6355;margin:0 0 14px}"
    ".ssr-langs{font:14px system-ui,sans-serif;color:#6A6355;margin:20px 0 0;"
    "padding-top:14px;border-top:1px solid #E0D9CB}"
    ".ssr-langs [aria-current=true]{font-weight:700;color:#171410}"
    ".ssr-related{margin-top:28px;padding-top:20px;border-top:1px solid #E0D9CB;"
    ...
    "#ssr-body .ssr-lead h1 a,#ssr-body .ssr-front li a{color:#171410}"
    "#ssr-body .ssr-lead h1 a:hover,#ssr-body .ssr-front li a:hover{color:#3A49AD}"
