...
SSR_CHROME_STYLE = (
    ...
    "font:17px/1.55 Georgia,'Times New Roman',serif;color:#1a1a1a}"
    "#ssr-body img{max-width:100%;height:auto}"
    "#ssr-body a{color:#0b57d0;text-decoration:none}"
    "#ssr-body a:hover{text-decoration:underline}"
    ".ssr-header{border-bottom:1px solid #ddd;padding-bottom:16px;margin-bottom:20px}"
    ".ssr-masthead{margin-bottom:12px}"
    ".ssr-brand{margin:0;font:700 1.35em Georgia,'Times New Roman',serif}"
    ".ssr-brand a{color:inherit}"
    ".ssr-tagline{margin:4px 0 0;font:13px/1.4 system-ui,sans-serif;color:#555}"
    ".ssr-nav ul{display:flex;flex-wrap:wrap;gap:6px 18px;margin:0;padding:0;list-style:none;"
    "font:14px system-ui,sans-serif}"
    ".ssr-nav a[aria-current=page]{font-weight:700;color:#111;text-decoration:underline}"
    ".ssr-crumbs{margin:0 0 18px;font:13px system-ui,sans-serif;color:#555}"
    ".ssr-crumbs ol{display:flex;flex-wrap:wrap;gap:4px 0;margin:0;padding:0;list-style:none}"
    ".ssr-crumbs li+li::before{content:'›';margin:0 8px;color:#999}"
    ".ssr-main{margin-bottom:28px}"
    ".ssr-footer{border-top:1px solid #ddd;padding-top:24px;"
    ...
    "text-transform:uppercase;color:#777;font-weight:700}"
    ".ssr-footer ul{margin:0;padding:0;list-style:none}"
    ".ssr-footer li{margin:0 0 6px}"
    ".ssr-footer-brand h2{font-size:1.05em;letter-spacing:0;text-transform:none;color:#111}"
    ".ssr-muted{color:#888;font-size:.92em}"
    ".ssr-rights{margin:0;font-size:12px;color:#888}"
    ".ssr-tags{font:14px system-ui,sans-serif;color:#555;margin:0 0 14px}"
    ".ssr-langs{font:14px system-ui,sans-serif;color:#555;margin:20px 0 0;"
    "padding-top:14px;border-top:1px solid #eee}"
    ".ssr-langs [aria-current=true]{font-weight:700;color:#111}"
    ".ssr-related{margin-top:28px;padding-top:20px;border-top:1px solid #ddd;"
