...
def x402_site_url() -> str:
    """Public base URL for the x402 marketplace's own domain -- x402 has no SSR document routes, only robots/sitemap; see sitemap.build_x402_sitemap, the one caller."""
