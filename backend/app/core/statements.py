...
# --------------------------------------------------------------------------- #
# x402_settlements / x402_settlements_by_tx (migration 090)
# --------------------------------------------------------------------------- #
class X402Stmts:
    """Prepared statements for the settlement ledger shared by every x402-gated module (modules/x402/settlement.py)."""
