...
def test_hero_url_encodes_literal_spaces() -> None:
    """A raw og:image URL with unencoded spaces must not break markdown link parsing.

    Found live 2026-08-09, risein.com -- CommonMark truncates a bare link
    destination at the first unescaped whitespace, spilling the rest as
    literal text right after the image.
    """
