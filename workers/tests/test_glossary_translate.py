"""Glossary term translation: the Mistral call for a short term+definition pair, and the Celery task that reads/writes it (mirrors translate_article_task's shape)."""
...
def test_translate_glossary_term_mistral_returns_translated_pair() -> None:
    ...
    result = translate_glossary_term_mistral(
...
def test_translate_glossary_term_mistral_falls_back_to_source_on_empty_response() -> None:
...
def test_task_translates_and_writes_when_language_missing(
    ...
    monkeypatch.setattr(
        "app.modules.newspaper.glossary_translate.translate_glossary_term_mistral",
