"""Bluesky posts are ingested as a plain https://bsky.app/... URL. Without an
explicit exemption, _compose_domain_for_row would misclassify every monitored
Bluesky account as sharing ONE "bsky.app" domain cap/cooldown, throttling
unrelated accounts against each other."""
...
def test_bluesky_post_is_exempt_from_domain_cap():
    row = _row(
        source_kind="bluesky",
...
def test_real_web_source_still_capped():
