...
def test_run_skips_when_mistral_not_configured(monkeypatch) -> None:
...
def test_run_skips_when_classifier_review_pending(monkeypatch) -> None:
    import app.core.config as config
...
def test_run_skips_on_feed_backlog_only_when_opted_in(monkeypatch) -> None:
    import app.core.config as config
...
def test_feed_backlog_does_not_pause_intake_by_default(monkeypatch) -> None:
...
def test_run_polls_all_scrape_sources(monkeypatch) -> None:
    import app.core.config as config
