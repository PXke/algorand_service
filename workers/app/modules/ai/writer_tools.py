...
SUGGEST_TOOL_SCHEMA: dict[str, Any] = {
    ...
    "function": {
        ...
        "description": (
            ...
            "for on-chain holdings and contract state, github_activity for repos, "
            "releases and contributors, search_leak_databases for offshore leaks, "
            "screen_sanctions_and_pep for people, discourse_forum for forum activity. "
            "ONLY when nothing existing fits, record the genuine gap (e.g. X/Twitter "
            "or Telegram search, an NFT collection's floor price, a historical TVL "
            "time-series). Do NOT suggest a capability you already have. This returns "
