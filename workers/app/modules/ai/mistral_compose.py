...
_TOOLS_GUIDANCE = (
    ...
    "ALGO PRICE/MARKET RULE: do not add price data by default. Fetch and mention "
    "the ALGO price ONLY when it materially helps the reader understand THIS "
    "story — e.g. a supply-cap or tokenomics change and its inflation impact, a "
    "treasury/funding move, or a markets/trading story. For product launches, dev "
    "tools, partnerships, governance procedure, NFTs and general news where price "
    "adds nothing, omit it. When in doubt, leave it out.\n"
