...
Amazonbot, and Internet Archive. Best-effort: never block or fail a publish over
this. The key is public (also served as {key}.txt at the site root).
"""
...
def _site_url() -> str:
    return config.PUBLIC_SITE_URL.rstrip("/")
