"""Celery task that polls xGov proposal state changes."""
...
def poll_xgov_proposals_task() -> dict[str, object]:
    """Hourly beat: enumerate xGov proposals from the registry escrow's created apps and signal each new (proposal, phase). See chain_tail.xgov_watch."""
