"""Shared Cassandra session, prepared-statement cache, and concurrent-execute helpers."""
...
def get_cassandra_session() -> CassandraSession:
    """Build (once per process) and return the shared Cassandra cluster session."""
